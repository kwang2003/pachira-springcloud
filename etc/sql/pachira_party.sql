...
CREATE TABLE `user_login_history` (
  ...
  `party_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_user_login_history_user_login` (`user_login_id`),
  CONSTRAINT `fk_user_login_history_user_login` FOREIGN KEY (`user_login_id`) REFERENCES `user_login` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
